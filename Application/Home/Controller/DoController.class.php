...
class DoController extends Controller {
    ...
    public function sendcode(){ //发送验证码
		$ip = $_SERVER['HTTP_X_FORWARDED_FOR'];
    ...
    public function lostpwd(){ //重置密码处理
	...
	public function contact_new(){ //新版留言入库
